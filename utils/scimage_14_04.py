...
def install_nfs():
    ...
    apt_install('nfs-kernel-server nfs-common portmap')
    run_command('ln -s /etc/init.d/nfs-kernel-server /etc/init.d/nfs')
    run_command('ln -s /lib/init/upstart-job /etc/init.d/portmap')
    run_command('ln -s /lib/init/upstart-job /etc/init.d/portmap-wait')
